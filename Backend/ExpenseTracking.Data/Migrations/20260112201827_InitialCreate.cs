        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsActive = table.Column<bool>(type: "bit", nullable: false),
                    RequireOwnerApprovalForOverBudget = table.Column<bool>(type: "bit", nullable: false),
                    CreatedDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                    ModifiedDate = table.Column<DateTime>(type: "datetime2", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_ExpenseGroups", x => x.GroupId);
                    table.ForeignKey(
                        name: "FK_ExpenseGroups_Users_OwnerId",
                        column: x => x.OwnerId,
                        principalTable: "Users",
                        principalColumn: "UserId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NotifyAtThreshold50 = table.Column<decimal>(type: "decimal(5,2)", nullable: false),
                    NotifyAtThreshold80 = table.Column<decimal>(type: "decimal(5,2)", nullable: false),
                    NotifyAtThreshold100 = table.Column<decimal>(type: "decimal(5,2)", nullable: false),
                    CreatedDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                    ModifiedDate = table.Column<DateTime>(type: "datetime2", nullable: true)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CriticalThreshold = table.Column<decimal>(type: "decimal(5,2)", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Budgets_ExpenseGroups_GroupId",
                        column: x => x.GroupId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ApprovalNote = table.Column<string>(type: "nvarchar(1000)", maxLength: 1000, nullable: false),
                    ApprovalDocumentPath = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: false),
                    GroupId = table.Column<int>(type: "int", nullable: true),
                    CreatedDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                    ModifiedDate = table.Column<DateTime>(type: "datetime2", nullable: true)
                },
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_UserGroups_ExpenseGroups_GroupId",
                        column: x => x.GroupId,
                        principalTable: "ExpenseGroups",
                        principalColumn: "GroupId",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BudgetId = table.Column<int>(type: "int", nullable: false),
                    UserId = table.Column<int>(type: "int", nullable: false),
                    ThresholdLevel = table.Column<decimal>(type: "decimal(5,2)", nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Budgets_UserId_CategoryId_Year_GroupId",
                table: "Budgets",
                columns: new[] { "UserId", "CategoryId", "Year", "GroupId" },
                unique: true,
                filter: "[CategoryId] IS NOT NULL AND [GroupId] IS NOT NULL");
